...
class IG:
    ...
    def __init__(self, model, img_size=(224, 224, 3)):
        self.model = model
    ...
    def random_baseline_integrated_gradients(self,
...
'''model = load_model("G:/Bucky/Python/Work/resnet50v2_basic.h5")
ig = IG(model)
img_path = "G:/Bucky/Python/Work/train/COVIDx_00004.png"
prediction, explanation = ig.igExplain(img_path)'''
